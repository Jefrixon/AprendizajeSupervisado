...
# 0 para habitación simple, 1 para habitación doble, 1 para posto letto y 2 para intero Appartamento
...
# Separamos la data con respecto al genero que se acepte.
...
# Predecimos el costo del hogar según la regresion lineal y la multiple hecha en los pasos anteriores
# Prediccion con regreción lineal
prediccion <- predict(regresionHombres, newdata = aux)
prediccion

# Prediccion con regreción multiple
...
# Predecimos el costo del hogar según la regresion lineal y la multiple hecha en los pasos anteriores
# Prediccion con regreción lineal
prediccion <- predict(regresionMujeres, newdata = aux)
prediccion
